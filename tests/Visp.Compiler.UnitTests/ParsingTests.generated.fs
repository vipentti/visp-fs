...
module ``tests_attributes_let-attributes-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/attributes/let-attributes-0.visp"
...
module ``tests_include_include-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/include/include-0.visp"

module ``tests_include_include-1`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/include/include-1.visp"

module ``tests_include_include-macros-0-macros`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/include/include-macros-0-macros.visp"

module ``tests_include_include-macros-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/include/include-macros-0.visp"
...
module ``tests_macros_dbg-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/macros/dbg-0.visp"
...
module ``tests_macros_my-const-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/macros/my-const-0.visp"
...
module ``tests_numbers_math-ops-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/numbers/math-ops-0.visp"

module ``tests_parsing_ambiguous-tokens-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/parsing/ambiguous-tokens-0.visp"
...
module ``tests_parsing_generic-args-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/parsing/generic-args-0.visp"
...
module ``tests_parsing_numbers-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/parsing/numbers-0.visp"
...
module ``tests_parsing_stars-in-places-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/parsing/stars-in-places-0.visp"
...
module ``tests_parsing_strings-interpolation-3`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/parsing/strings-interpolation-3.visp"
...
module ``tests_pats_record-pat-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/pats/record-pat-0.visp"
...
module ``tests_type_lambda-shorthand-record-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/type/lambda-shorthand-record-0.visp"
...
module ``tests_type_object-exprs-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/type/object-exprs-0.visp"
...
module ``tests_type_record-mut-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/type/record-mut-0.visp"

module ``tests_type_static-members-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/type/static-members-0.visp"
...
module ``tests_type_val-ctor-0`` =
    [<Fact>]
    let ``can parse`` () = TestUtils.runTest "tests/type/val-ctor-0.visp"
