...
module ``tests_include_include-macros-0-macros`` =
    [<Fact>]
    let ``structured output`` () = TestUtils.runStructuredOutputTest "tests/include/include-macros-0-macros.visp"

module ``tests_include_include-macros-0`` =
    [<Fact>]
    let ``structured output`` () = TestUtils.runStructuredOutputTest "tests/include/include-macros-0.visp"
...
module ``tests_macros_dbg-0`` =
    [<Fact>]
    let ``structured output`` () = TestUtils.runStructuredOutputTest "tests/macros/dbg-0.visp"
...
module ``tests_parsing_stars-in-places-0`` =
    [<Fact>]
    let ``structured output`` () = TestUtils.runStructuredOutputTest "tests/parsing/stars-in-places-0.visp"
...
module ``tests_type_record-mut-0`` =
    [<Fact>]
    let ``structured output`` () = TestUtils.runStructuredOutputTest "tests/type/record-mut-0.visp"
